...
if ~isempty(varargin)>0 % you set a parameter?
    switch lower(varargin{1})
        ...
        case 'blue mat'
            lineStyles = whiteFade(N,'blue mat'); return;
        case 'red mat'
            lineStyles = whiteFade(N,'red mat'); return;
        case 'green'
...
switch thisColor
    ...
    case 'blue mat'
        cmapp = [247,251,255;158,202,225;107,174,214;66,146,198;33,113,181;8,81,156;8,48,107];
    case 'red'
        cmapp = [255,245,240;254,224,210;252,187,161;252,146,114;251,106,74;239,59,44;203,24,29;165,15,21;103,0,13];
    case 'red mat'
        cmapp = [255,245,240;252,146,114;251,106,74;239,59,44;203,24,29];
    otherwise
