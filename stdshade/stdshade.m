function stdshade(amean, astd,alpha,acolor,F,style,smth)
...
hold on;plot(F,amean,'.-','color',acolor,'linewidth',1.5,'MarkerSize',15); %% change color or linewidth to adjust mean line
